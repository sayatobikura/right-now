        ...
        {isFirebaseConfigured && onGoogleSignIn && (
          <div className="mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-medium rounded-lg py-2.5 transition-colors border border-gray-300"
            >
